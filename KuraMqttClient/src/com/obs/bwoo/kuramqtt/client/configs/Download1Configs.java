 ...
 *
 */
public class Download1Configs extends PubSubConfigs
{

	public Download1Configs(String accountId, String requestId, String requesterClientId, String targetClientId)
	{
	...
	public Map<String, Object> getPayload()
	{
		...
		payloadMap.put("dp.uri", "https://github.com/brianwoo/eclipse_kura_prototype/"
				...
				+ "resources/obsBwooTemperatureReader_reg_strings.dp");
		payloadMap.put("dp.name", "obsBwooTemperatureReader");
		payloadMap.put("dp.version", "1.0.2");
